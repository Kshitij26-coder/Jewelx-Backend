...
public class SaleEntity {
	   ...
	   @ManyToOne
	    ...
	    @Column(name = "cash_payment", precision = 15, scale = 2, nullable = false)
	    private BigDecimal cashPayment;

	    @Column(name = "online_payment", precision = 15, scale = 2, nullable = false)
	    private BigDecimal onlinePayment;

	    @Column(name = "cheques_payment", precision = 8, scale = 2, nullable = false)
